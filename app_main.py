#!/usr/bin/env python3
"""
摔倒检测系统 - Streamlit 可视化界面（高性能版 + 认证）
...
with st.sidebar:
    ...
    <div style='background-color: #f0f2f6; padding: 15px; border-radius: 10px; margin-bottom: 20px;'>
        <p style='margin: 0; font-size: 14px;'><strong>👤 当前用户:</strong></p>
        <p style='margin: 5px 0; font-size: 16px; color: #1f77b4;'>{username}</p>
        <p style='margin: 0; font-size: 12px; color: #666;'>角色：{user_role.upper()}</p>
    </div>
